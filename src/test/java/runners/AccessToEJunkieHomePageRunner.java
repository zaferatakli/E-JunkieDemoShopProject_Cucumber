...
@CucumberOptions(features = {"src/test/java/featureFiles/AccessToEJunkieHomePage.feature"},
...
public class AccessToEJunkieHomePageRunner extends AbstractTestNGCucumberTests {
    ...
    public void writeExtendReport() {
        ...
        ExtentService.getInstance().setSystemInfo("Test Tag", "Access To EJunkie Home Page Test");
